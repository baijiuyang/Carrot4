function [x, y, spd, hdn] = Carrot4_trajectoryGenerator(x0,y0,...
    nDuration,d0,v0,dv,a,heading1,heading2,startupDuration,manipOnset,...
    frameRate)
...
manipOnset = int16(manipOnset * frameRate);
